...
| Bloco | Título | Status |
|---|---|---|
| 01 | Cross-Platform Self-Host Docs Casing | Concluído |
...
Bloco 01 concluído: estrutura física do repositório corrigida para portabilidade cross-platform, sem perda de conteúdo. Demais blocos ainda não iniciados.
