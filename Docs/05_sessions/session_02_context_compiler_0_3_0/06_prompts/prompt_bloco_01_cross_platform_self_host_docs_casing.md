# Prompt — Bloco 01: cross platform self host docs casing
...
- O bloco completo em `Docs/05_sessions/session_02_context_compiler_0_3_0/05_blocks/bloco_01_cross_platform_self_host_docs_casing.md`
...
```
ddae-engine feedback create --block bloco_01_cross_platform_self_host_docs_casing --session session_02_context_compiler_0_3_0
```
...
```
feat(cross_platform_self_host_docs_casing): _..._
```
