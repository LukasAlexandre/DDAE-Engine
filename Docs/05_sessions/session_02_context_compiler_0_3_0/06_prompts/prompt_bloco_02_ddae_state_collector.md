# Prompt — Bloco 02: DDAE State Collector
...
- O bloco completo em `Docs/05_sessions/session_02_context_compiler_0_3_0/05_blocks/bloco_02_ddae_state_collector.md`
...
```
ddae-engine feedback create --block bloco_02_ddae_state_collector --session session_02_context_compiler_0_3_0
```
